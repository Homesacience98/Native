...
import { Text, View,Button ,StyleSheet, FlatList,Image, Touchable, TouchableOpacity} from 'react-native'
...
<TouchableOpacity  onPress={()=> navigation.navigate('Food')}>
          ...
          <View> 
            <Text  style={{fontSize: 20, fontWeight:'bold',}} > Food Options</Text>
