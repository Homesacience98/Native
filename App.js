        ...
        <Stack.Navigator screenOptions={{headerTintColor:'white', headerStyle: {backgroundColor:'green',height: 80,} }}>
          ...
          <Stack.Screen options={{ headerRight: () => (
              <Icon
                ...
                style={{ marginLeft: 10 }}
              />
            ), headerTintColor:'yellow', headerStyle:{backgroundColor: "black",} }} name="Welcome to Salam" component={Explore} />
          ...
          <Stack.Screen  options={{ headerStyle:{backgroundColor: "black",} }} name="Details" component={DetailScreen} />
          <Stack.Screen  options={{ headerStyle:{backgroundColor: "black",} }} name="Drinks" component={DesertList} />
          <Stack.Screen  options={{ headerStyle:{backgroundColor: "black",} }} name="Food" component={FoodView} />
